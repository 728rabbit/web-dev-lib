...
var iweb={mode:"default",default_language:"en",init_status:!1,processing_status:!1,win_width:0,win_scroll_top:0,csfr_token:"",language:[],initialize:function(i){var e=this;e.mode=e.isValue($("body").data("macosx"))&&parseInt($("body").data("macosx"))>0&&!e.detectDevice()?"macosx":"default",e.processing(parseInt($("body").data("processing"))),e.language.en={btn_confirm:"OK",btn_yes:"Yes",btn_no:"No",select:"Please select"},e.language["zh-hant"]={btn_confirm:"確定",btn_yes:"是",btn_no:"否",select:"請選擇"},e.language["zh-hans"]={btn_confirm:"确定",btn_yes:"是",btn_no:"否",select:"请选择"},e.isValue($("html").attr("lang"))&&e.isValue(e.language[$("html").attr("lang").toString().toLowerCase()])&&(e.default_language=$("html").attr("lang").toString().toLowerCase()),$("body").find(".iweb-editor").fitVids(),$("body").find("select").each(function(i){if(!$(this).parent().hasClass("iweb-selector")&&($(this).wrap('<div class="iweb-selector"><div class="choice"></div></div>'),$(this).parents(".iweb-selector").find(".choice").prepend('<div class="arrow"></div>'),e.isValue($(this).data("virtual")))){$(this).addClass("shidden"),$(this).removeAttr("data-virtual");var t="",s=e.language[e.default_language].select;t+='<ul class="virtual-option-list" data-index="iss'+i+'">',$.each($(this).children(),function(){parseInt($(this).children().length)>0?(t+='<li class="virtual-parent-node"><span>'+$(this).attr("label")+"</span>",t+='<ul class="virtual-option-child-list">',$.each($(this).children(),function(){$(this).is(":selected")?(s=$(this).text(),t+='<li class="virtual-node virtual-node-selected" data-value="'+$(this).val()+'"><span>'+$(this).text()+"</span></li>"):t+='<li class="virtual-node" data-value="'+$(this).val()+'"><span>'+$(this).text()+"</span></li>"}),t+="</ul>",t+="</li>"):$(this).is(":selected")?(s=$(this).text(),t+='<li class="virtual-node virtual-node-selected" data-value="'+$(this).val()+'"><span>'+$(this).text()+"</span></li>"):t+='<li class="virtual-node" data-value="'+$(this).val()+'"><span>'+$(this).text()+"</span></li>"}),t='<div class="virtual-choice"><div><span>'+s+"</span></div><div>"+(t+="</ul>")+"</div></div>",$(this).parents(".iweb-selector").append(t)}}),$("body").removeAttr("data-processing"),$("body").removeAttr("data-macosx"),$("body > *").not("script,noscript").wrapAll('<div class="iweb-viewer"></div>'),e.responsive(),e.win_width=parseInt($(window).width()),"macosx"===e.mode&&e.scrollbar("body > .iweb-viewer","macosx",function(i){e.init_status&&(e.win_scroll_top=parseInt(i.scroll),"function"==typeof iweb_scroll&&iweb_scroll(i),"function"==typeof iweb_iscroll&&iweb_iscroll(i))}),"function"==typeof iweb_layout&&iweb_layout(e.win_width),"function"==typeof iweb_ilayout&&iweb_ilayout(e.win_width),"function"==typeof iweb_func&&iweb_func(),"function"==typeof iweb_ifunc&&iweb_ifunc(),$(document).on("change",".iweb-selector > .choice > select",function(){var i=$(this).val();$(this).parents(".iweb-selector").find(".virtual-choice li.virtual-node").each(function(){$(this).data("value").toString()===i.toString()?($(this).addClass("virtual-node-selected"),$(this).parents(".iweb-selector").find(".virtual-choice > div > span").html($(this).text())):$(this).removeClass("virtual-node-selected")})}),$(document).on("click",".iweb-selector > .virtual-choice > div > span",function(){var i=$(this);$(".iweb-selector > .virtual-choice > div > ul").each(function(){e.isMatch($(this).data("index"),i.parents(".iweb-selector").find(".virtual-choice > div > ul").data("index"))||$(this).hide()}),i.parents(".iweb-selector").find(".virtual-choice > div > ul").is(":visible")?i.parents(".iweb-selector").find(".virtual-choice > div > ul").hide():i.parents(".iweb-selector").find(".virtual-choice > div > ul").show()}),$(document).on("click",".virtual-choice li.virtual-node",function(){$(this).parents(".iweb-selector").find(".virtual-choice > div > ul").hide(),$(this).parents(".iweb-selector").find(".virtual-choice > div > span").html($(this).text()),$(this).parents(".iweb-selector").find(".choice > select").val($(this).data("value")).trigger("change")}),$(document).on("click","body",function(i){0===parseInt($(i.target).parents(".iweb-selector").length)&&$(".iweb-selector > .virtual-choice > div > ul").hide()}),$(document).on("keypress","body",function(i){if(13==(i.keyCode?i.keyCode:i.which)&&e.isExist("#iweb-alert"))return i.preventDefault(),!1}),$("body").addClass("iweb"),"macosx"===e.mode?$("body").addClass("iweb-macosx"):e.detectDevice()?$("body").addClass("iweb-mobile-viewer"):$("body").addClass("iweb-viewer")},processing:function(i,e){if(this.isMatch(i,1)||this.isMatch(i,!0)){var t="";t=this.isValue(e)?'<div id="iweb-processing" class="iweb-processing iweb-processing-opacity">':'<div id="iweb-processing" class="iweb-processing">',t+='<div class="loading">',t+='<svg class="icon" x="0px" y="0px" viewBox="0 0 150 150">',t+='<circle class="circle" cx="75" cy="75" r="60"></circle>',t+="</svg>",t+="</div>",t+="</div>",$("body").prepend(t)}else{var s=500;this.isNumber(e)&&(s=parseInt(e));var n=setTimeout(function(){$("#iweb-processing").remove(),clearTimeout(n)},s)}},resizing:function(){return!(!this.init_status||this.win_width===parseInt($(window).width()))&&(this.win_width=parseInt($(window).width()),!0)},responsive:function(){var i=this;i.isExist(".iweb-responsive")&&$(".iweb-responsive").each(function(){var e=$(this).innerWidth(),t=0,s=$(this).data("width"),n=$(this).data("height");i.isValue(s)&&i.isValue(n)&&n>0&&s>0&&(t=parseInt(e*n/s)),t>0?$(this).css("height",t+"px"):$(this).css("height","auto")})},scrollto:function(i,e,t){var s=0;e=this.isValue(e)?parseInt(e):0;"macosx"===this.mode?this.isExist(i)?(s=parseInt($(i).first().offset().top),s=this.win_scroll_top+s-e,$(i).first().closest(".iscroll-content").animate({scrollTop:s},500).promise().then(function(){"function"==typeof t&&t()})):$(".iscroll-content").animate({scrollTop:s},500).promise().then(function(){"function"==typeof t&&t()}):(this.isExist(i)&&(s=Math.max(0,parseInt($(i).first().offset().top)-e)),$("html,body").animate({scrollTop:s},500).promise().then(function(){"function"==typeof t&&t()}))},scrollbar:function(i,e,t){this.isExist(i)&&$(i).iScroll({mode:this.isValue(e)?e:"outer",onScroll:function(i,e){"function"==typeof t&&t(i)}})},pagination:function(i,e){this.isValue(e)?$(i).iweb_pagination(e):$(i).iweb_pagination()},alert:function(i,e,t){if(!this.isExist("#iweb-alert")){this.processing(!1);var s="",n="",a=this.language[this.default_language].btn_confirm;this.isValue(t)&&(this.isValue(t.class)&&(n=t.class),this.isValue(t.btn)&&(a=t.close)),this.isValue(n)?s+='<div id="iweb-alert" class="iweb-alert '+n+'">':s+='<div id="iweb-alert" class="iweb-alert">',s+="<div>",s+='<div class="async-content">',s+="<div>",s+='<div class="message">',s+=i,s+="</div>",s+='<button class="btn btn-close">'+a+"</button>",s+="</div>",s+="</div>",s+="</div>",s+="</div>",$("body").prepend(s).each(function(){$("body").hasClass("iweb-macosx")||$("body").addClass("iweb-disable-scroll"),$(document).on("click",".iweb-alert .async-content > div > .btn-close",function(){$(document).off("click",".iweb-alert .async-content > div > .btn-close"),$("#iweb-alert").remove(),$("body").removeClass("iweb-disable-scroll"),"function"==typeof e&&e()})})}},confirm:function(i,e,t){if(!this.isExist("#iweb-alert")){this.processing(!1);var s="",n="",a=this.language[this.default_language].btn_yes,o=this.language[this.default_language].btn_no;this.isValue(t)&&(this.isValue(t.class)&&(n=t.class),this.isValue(t.yes)&&(a=t.yes),this.isValue(t.no)&&(o=t.no)),this.isValue(n)?s+='<div id="iweb-alert" class="iweb-alert '+n+'">':s+='<div id="iweb-alert" class="iweb-alert">',s+="<div>",s+='<div class="async-content">',s+="<div>",s+='<div class="message">',s+=i,s+="</div>",s+='<button class="btn btn-yes">'+a+"</button>",s+='<button class="btn btn-no">'+o+"</button>",s+="</div>",s+="</div>",s+="</div>",s+="</div>",$("body").prepend(s).each(function(){$("body").hasClass("iweb-macosx")||$("body").addClass("iweb-disable-scroll"),$(document).on("click",".iweb-alert .async-content > div > .btn-yes",function(){$(document).off("click",".iweb-alert .async-content > div > .btn-yes"),$("#iweb-alert").remove(),$("body").removeClass("iweb-disable-scroll"),"function"==typeof e&&e(!0)}),$(document).on("click",".iweb-alert .async-content > div > .btn-no",function(){$(document).off("click",".iweb-alert .async-content > div > .btn-no"),$("#iweb-alert").remove(),$("body").removeClass("iweb-disable-scroll"),"function"==typeof e&&e(!1)})})}},dialog:function(i,e,t,s){if(!this.isExist("#iweb-dialog")){this.processing(!1);var n="";this.isValue(s)?this.isValue(s.class)?n+='<div id="iweb-dialog" class="iweb-dialog '+s.class+'" style="opacity:0;">':n+='<div id="iweb-dialog" class="iweb-dialog" style="opacity:0;">':n+='<div id="iweb-dialog" class="iweb-dialog">',n+="<div>",n+='<div class="async-loading">',n+='<svg class="icon" x="0px" y="0px" viewBox="0 0 150 150">',n+='<circle class="circle" cx="75" cy="75" r="60"></circle>',n+="</svg>",n+="</div>",n+='<div class="async-virtual"></div>',n+='<div class="async-content">',n+='<a class="btn btn-close">×</a>',n+="<div>",n+=i,n+="</div>",n+="</div>",n+="</div>",n+="</div>",$("body").prepend(n).each(function(){$("body").hasClass("iweb-macosx")?$("#iweb-dialog > .inner").iScroll({mode:"macosx"}):$("body").addClass("iweb-disable-scroll"),"function"==typeof e&&e(),$(document).on("click",".iweb-dialog .async-virtual",function(i){$(document).off("click",".iweb-dialog .async-content .btn-close"),$("#iweb-dialog").remove(),$("body").removeClass("iweb-disable-scroll"),"function"==typeof t&&t()}),$(document).on("click",".iweb-dialog .async-content .btn-close",function(){$(document).off("click",".iweb-dialog .async-content .btn-close"),$("#iweb-dialog").remove(),$("body").removeClass("iweb-disable-scroll"),"function"==typeof t&&t()});var i=setTimeout(function(){$(".iweb-dialog .async-loading").remove(),$(".iweb-dialog .async-content").animate({opacity:1}),clearTimeout(i)},1e3)})}},post:function(i,e){var t=this,s=!1,n="",a={},o="json";t.isValue(i)&&(t.isValue(i.url)&&(n=i.url,s=!0),t.isValue(i.val)&&(a=i.val),t.isValue(i.type)&&(o=i.type)),s&&!t.processing_status&&(t.processing_status=!0,t.isValue(i.loading)&&t.processing(!0,!0),$.ajax({url:n,type:"post",data:a,dataType:o,success:function(i){var s=setTimeout(function(){t.processing_status=!1,$("#iweb-processing").remove(),clearTimeout(s),"function"==typeof e&&e(i)},1e3)},error:function(i,e,s){return t.processing_status=!1,$("#iweb-processing").remove(),alert(s),!1}}))},form:function(i,e,t,s){var n=this;if(i="#"+i.toString().replace("#",""),n.isExist(i)){object=this;var a="json";n.isValue(e)&&(a=e),n.isValue($(i).data("token"))&&(n.csfr_token=$(i).data("token"),$(i).removeAttr("data-token")),$(i).ajaxForm({dataType:a,beforeSubmit:function(i,e,s){return!n.processing_status&&(!("function"==typeof t&&!t(i))&&(i.push({name:"async_status",value:1}),i.push({name:"csrf_token",value:n.csfr_token}),n.processing_status=!0,n.processing(!0,!0),"function"!=typeof t||void 0))},success:function(i){var e=setTimeout(function(){n.processing_status=!1,$("#iweb-processing").remove(),clearTimeout(e),"function"==typeof s&&s(i)},1e3)},error:function(i,e,t){return n.processing_status=!1,$("#iweb-processing").remove(),alert(t),!1}})}},isValue:function(i){return null!=i&&("object"==typeof i||"array"==typeof i?parseInt(Object.keys(i).length)>0:"boolean"==typeof i?i:""!==$.trim(i))},isNumber:function(i){if(this.isValue(i)){return/^[0-9]+$/.test(i)}return!1},isEmail:function(i){if(this.isValue(i)){return/^([A-Za-z0-9_\-\.])+\@([A-Za-z0-9_\-\.])+\.([A-Za-z]{2,4})$/.test(i)}return!1},isPassword:function(i){if(this.isValue(i)){return/^(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{6,}$/.test(i)}return!1},isMatch:function(i,e,t){return!(!this.isValue(i)||!this.isValue(e))&&(iweb.isValue(t)&&(t||1===parseInt(t))?$.trim(i).toString()===$.trim(e).toString():$.trim(i).toString().toLowerCase()===$.trim(e).toString().toLowerCase())},isExist:function(i){return parseInt($(i).length)>0},detectDevice:function(i){var e=function(){return navigator.userAgent.match(/Android/i)},t=function(){return navigator.userAgent.match(/BlackBerry/i)},s=function(){return navigator.userAgent.match(/Mac|iPhone|iPad|iPod/i)},n=function(){return navigator.userAgent.match(/Opera Mini/i)},a=function(){return navigator.userAgent.match(/IEMobile/i)};switch(i){case"android":return e();case"blackberry":return t();case"ios":return s();case"opera":return n();case"windows":return a();default:return e()||t()||s()||n()||a()}}};
