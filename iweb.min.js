...
var iweb={mode:"default",default_language:"en",init_status:!1,processing_status:!1,win_width:0,win_scroll_top:0,csrf_token:"",language:[],initialize:function(i){var e=this;e.mode=e.isValue($("body").data("macosx"))&&parseInt($("body").data("macosx"))>0&&!e.detectDevice()?"macosx":"default",e.processing(parseInt($("body").data("processing"))),e.language.en={btn_confirm:"OK",btn_yes:"Yes",btn_no:"No",select:"Please select"},e.language["zh-hant"]={btn_confirm:"確定",btn_yes:"是",btn_no:"否",select:"請選擇"},e.language["zh-hans"]={btn_confirm:"确定",btn_yes:"是",btn_no:"否",select:"请选择"},e.isValue($("html").attr("lang"))&&e.isValue(e.language[$("html").attr("lang").toString().toLowerCase()])&&(e.default_language=$("html").attr("lang").toString().toLowerCase()),$("body > *").not("script,noscript").wrapAll('<div class="iweb-viewer"></div>'),"macosx"===e.mode&&e.scrollbar("body > .iweb-viewer","macosx",function(i){e.init_status&&(e.win_scroll_top=parseInt(i.scroll),"function"==typeof iweb_scroll&&iweb_scroll(i),"function"==typeof iweb_iscroll&&iweb_iscroll(i))}),$("body").find(".iweb-editor").fitVids({ignore:".fitvids-non"}),e.selector(),e.checkbox(),e.radiobox(),e.responsive(),e.win_width=parseInt($(".iweb-viewer").width()),$(document).on("change",".iweb-selector > .real-choice > select",function(){var i=$(this).val();$(this).parents(".iweb-selector").find(".virtual-choice li.virtual-node").each(function(){$(this).data("value").toString()===i.toString()?($(this).addClass("virtual-node-selected"),$(this).parents(".iweb-selector").find(".virtual-choice > div > span").html($(this).text())):$(this).removeClass("virtual-node-selected")})}),$(document).on("click",".iweb-selector > .virtual-choice > div > span",function(){var i=$(this);$(".iweb-selector > .virtual-choice > div > ul").each(function(){e.isMatch($(this).data("index"),i.parents(".iweb-selector").find(".virtual-choice > div > ul").data("index"))||$(this).hide()}),i.parents(".iweb-selector").find(".virtual-choice > div > ul").is(":visible")?i.parents(".iweb-selector").find(".virtual-choice > div > ul").hide():i.parents(".iweb-selector").find(".virtual-choice > div > ul").show()}),$(document).on("click",".virtual-choice li.virtual-node",function(){$(this).parents(".iweb-selector").find(".virtual-choice > div > ul").hide(),$(this).parents(".iweb-selector").find(".virtual-choice > div > span").html($(this).text()),$(this).parents(".iweb-selector").find(".real-choice > select").val($(this).data("value")).trigger("change")}),$(document).on("click",".iweb-checkbox > .virtual-option > div > input",function(){$(this).is(":checked")?$(this).parent().addClass("checked"):$(this).parent().removeClass("checked")}),$(document).on("click",".iweb-radiobox > .virtual-option > div > input",function(){var i=$(this).val(),e=$('input[type="radio"][name="'+$(this).attr("name")+'"]');$.each(e,function(){iweb.isMatch($(this).val(),i)?($(this).prop("checked",!0),$(this).parent().addClass("checked")):($(this).prop("checked",!1),$(this).parent().removeClass("checked"))})}),$(document).on("click","body",function(i){0===parseInt($(i.target).parents(".iweb-selector").length)&&$(".iweb-selector > .virtual-choice > div > ul").hide()}),$(document).on("keypress","body",function(i){if(13==(i.keyCode?i.keyCode:i.which)&&e.isExist("#iweb-alert"))return i.preventDefault(),!1}),$(document).on("click",".font-switch",function(i){i.preventDefault(),$(".font-switch").removeClass("current"),$("html").removeClass("small-font"),$("html").removeClass("large-font"),(e.isMatch($(this).data("size"),"small")||e.isMatch($(this).data("size"),"large"))&&$("html").addClass($(this).data("size")+"-font"),iweb.setCookie("iweb_font_sizse",$(this).data("size"),14),$(".font-switch").each(function(){e.isMatch($(this).data("size"),iweb.getCookie("iweb_font_sizse"))?$(this).addClass("current"):$(this).removeClass("current")})}),e.isValue(iweb.getCookie("iweb_font_sizse"))&&((e.isMatch(iweb.getCookie("iweb_font_sizse"),"small")||e.isMatch(iweb.getCookie("iweb_font_sizse"),"large"))&&$("html").addClass(iweb.getCookie("iweb_font_sizse")+"-font"),$(".font-switch").each(function(){e.isMatch($(this).data("size"),iweb.getCookie("iweb_font_sizse"))?$(this).addClass("current"):$(this).removeClass("current")})),"function"==typeof iweb_layout&&iweb_layout(e.win_width),"function"==typeof iweb_ilayout&&iweb_ilayout(e.win_width),"function"==typeof iweb_func&&iweb_func(),"function"==typeof iweb_ifunc&&iweb_ifunc(),$("body").removeAttr("data-processing"),$("body").removeAttr("data-macosx"),$("body").addClass("iweb"),e.detectDevice()&&$("body").addClass("iweb-mobile"),"macosx"===e.mode&&$("body").addClass("iweb-macosx")},processing:function(i,e){if(this.isMatch(i,1)||this.isMatch(i,!0)){if(!this.isExist("#iweb-processing")){var t="";t=this.isValue(e)?'<div id="iweb-processing" class="iweb-processing iweb-processing-opacity">':'<div id="iweb-processing" class="iweb-processing">',t+='<div class="loading">',t+='<svg class="icon" x="0px" y="0px" viewBox="0 0 150 150">',t+='<circle class="circle" cx="75" cy="75" r="60"></circle>',t+="</svg>",t+="</div>",t+="</div>",$("body").prepend(t)}}else{var s=500;this.isNumber(e)&&(s=parseInt(e));var a=setTimeout(function(){$("#iweb-processing").remove(),clearTimeout(a)},s)}},resizing:function(){return!(!this.init_status||this.win_width===parseInt($(".iweb-viewer").width()))&&(this.win_width=parseInt($(window).width()),!0)},responsive:function(){var i=this;i.isExist(".iweb-responsive")&&$(".iweb-responsive").each(function(){var e=$(this).innerWidth(),t=0,s=$(this).data("width"),a=$(this).data("height");i.isValue(s)&&i.isValue(a)&&a>0&&s>0&&(t=parseInt(e*a/s)),t>0?$(this).css("height",t+"px"):$(this).css("height","auto")})},scrollto:function(i,e,t){var s=0;e=this.isValue(e)?parseInt(e):0;"macosx"===this.mode?this.isExist(i)?(s=parseInt($(i).first().offset().top),s=this.win_scroll_top+s-e,$(i).first().closest(".iscroll-content").animate({scrollTop:s},500).promise().then(function(){"function"==typeof t&&t()})):$(".iscroll-content").animate({scrollTop:s},500).promise().then(function(){"function"==typeof t&&t()}):(this.isExist(i)&&(s=Math.max(0,parseInt($(i).first().offset().top)-e)),$("html,body").animate({scrollTop:s},500).promise().then(function(){"function"==typeof t&&t()}))},scrollbar:function(i,e,t){this.isExist(i)&&$(i).iScroll({mode:this.isMatch(e,"macosx")?e:"outer",onScroll:function(i,e){"function"==typeof t&&t(i)}})},selector:function(i,e){var t=this;t.isValue(i)||(i=$("body").find("select")),i.each(function(i){if(!$(this).parent().parent().hasClass("iweb-selector")&&($(this).wrap('<div class="iweb-selector"><div class="real-choice"></div></div>'),$(this).parents(".iweb-selector").find(".real-choice").prepend('<div class="arrow"></div>'),t.isMatch($(this).data("virtual"),1)||t.isMatch($(this).data("virtual"),!0))){$(this).addClass("shidden"),$(this).removeAttr("data-virtual");var e="",s=t.language[t.default_language].select;e+='<ul class="virtual-option-list" data-index="iss'+i+'">',$.each($(this).children(),function(){parseInt($(this).children().length)>0?(e+='<li class="virtual-parent-node"><span>'+$(this).attr("label")+"</span>",e+='<ul class="virtual-option-child-list">',$.each($(this).children(),function(){$(this).is(":selected")?(s=$(this).text(),e+='<li class="virtual-node virtual-node-selected" data-value="'+$(this).val()+'" data-ori="selected"><span>'+$(this).text()+"</span></li>"):e+='<li class="virtual-node" data-value="'+$(this).val()+'"><span>'+$(this).text()+"</span></li>"}),e+="</ul>",e+="</li>"):$(this).is(":selected")?(s=$(this).text(),e+='<li class="virtual-node virtual-node-selected" data-value="'+$(this).val()+'" data-ori="selected"><span>'+$(this).text()+"</span></li>"):e+='<li class="virtual-node" data-value="'+$(this).val()+'"><span>'+$(this).text()+"</span></li>"}),e='<div class="virtual-choice"><div><span>'+s+'</span></div><div class="virtual-option">'+(e+="</ul>")+"</div></div>",$(this).parents(".iweb-selector").append(e);var a=$(this).parents(".iweb-selector:first").find(".virtual-choice");$(this).parents("form:first").on("reset",function(){var i=null;a.find(".virtual-node").each(function(e){(0===parseInt(e)||t.isMatch($(this).data("ori"),"selected"))&&(i=$(this))}),t.isValue(i)&&i.trigger("click")})}}),"function"==typeof e&&e()},checkbox:function(i,e){var t=this;t.isValue(i)||(i=$("body").find('input[type="checkbox"]')),i.each(function(){if(!$(this).parent().hasClass("iweb-checkbox")){var i=$(this).next(),e=$(this).is(":checked");parseInt(i.length)>0&&t.isMatch(i[0].nodeName,"label")?($(this).wrap('<div class="iweb-checkbox"><div class="virtual-option"><div'+(e?' class="checked"':"")+'></div></div><div class="virtual-msg">'+i[0].outerHTML+"</div></div>"),i.remove()):$(this).wrap('<div class="iweb-checkbox"><div class="virtual-option"><div'+(e?' class="checked"':"")+'></div></div><div class="virtual-msg">&nbsp;</div></div>'),e&&$(this).attr("data-ori","checked");var s=$(this);$(this).parents("form:first").on("reset",function(){t.isMatch(s.data("ori"),"checked")?s.parent().addClass("checked"):s.parent().removeClass("checked")})}}),"function"==typeof e&&e()},radiobox:function(i,e){var t=this;t.isValue(i)||(i=$("body").find('input[type="radio"]')),i.each(function(){if(!$(this).parent().hasClass("iweb-radiobox")){var i=$(this).next(),e=$(this).is(":checked");parseInt(i.length)>0&&t.isMatch(i[0].nodeName,"label")?($(this).wrap('<div class="iweb-radiobox"><div class="virtual-option"><div'+(e?' class="checked"':"")+'></div></div><div class="virtual-msg">'+i[0].outerHTML+"</div></div>"),i.remove()):$(this).wrap('<div class="iweb-radiobox"><div class="virtual-option"><div'+(e?' class="checked"':"")+'></div></div><div class="virtual-msg">&nbsp;</div></div>'),e&&$(this).attr("data-ori","checked");var s=$(this);$(this).parents("form:first").on("reset",function(){t.isMatch(s.data("ori"),"checked")?s.parent().addClass("checked"):s.parent().removeClass("checked")})}}),"function"==typeof e&&e()},pagination:function(i,e){this.isValue(e)?$(i).iweb_pagination(e):$(i).iweb_pagination()},alert:function(i,e,t){var s=this;if(!s.isExist("#iweb-alert")){s.processing(!1,0);var a="",n="",o=s.language[s.default_language].btn_confirm;s.isValue(t)&&(s.isValue(t.class)&&(n=t.class),s.isValue(t.btn)&&(o=t.close)),s.isValue(n)?a+='<div id="iweb-alert" class="iweb-alert '+n+'">':a+='<div id="iweb-alert" class="iweb-alert">',a+="<div>",a+='<div class="async-content">',a+="<div>",a+='<div class="message">',a+=i,a+="</div>",a+='<button class="btn btn-close">'+o+"</button>",a+="</div>",a+="</div>",a+="</div>",a+="</div>",$(".iweb > .iweb-viewer").prepend(a).each(function(){$("body").hasClass("iweb-macosx")||$("body").addClass("iweb-disable-scroll"),$(document).on("click",".iweb-alert .async-content > div > .btn-close",function(){$(document).off("click",".iweb-alert .async-content > div > .btn-close"),$("#iweb-alert").remove(),s.isExist("#iweb-dialog")||$("body").removeClass("iweb-disable-scroll"),"function"==typeof e&&e()})})}},confirm:function(i,e,t){var s=this;if(!s.isExist("#iweb-alert")){s.processing(!1,0);var a="",n="",o=s.language[s.default_language].btn_yes,c=s.language[s.default_language].btn_no;s.isValue(t)&&(s.isValue(t.class)&&(n=t.class),s.isValue(t.yes)&&(o=t.yes),s.isValue(t.no)&&(c=t.no)),s.isValue(n)?a+='<div id="iweb-alert" class="iweb-alert '+n+'">':a+='<div id="iweb-alert" class="iweb-alert">',a+="<div>",a+='<div class="async-content">',a+="<div>",a+='<div class="message">',a+=i,a+="</div>",a+='<button class="btn btn-yes">'+o+"</button>",a+='<button class="btn btn-no">'+c+"</button>",a+="</div>",a+="</div>",a+="</div>",a+="</div>",$(".iweb > .iweb-viewer").prepend(a).each(function(){$("body").hasClass("iweb-macosx")||$("body").addClass("iweb-disable-scroll"),$(document).on("click",".iweb-alert .async-content > div > .btn-yes",function(){$(document).off("click",".iweb-alert .async-content > div > .btn-yes"),$(document).off("click",".iweb-alert .async-content > div > .btn-no"),$("#iweb-alert").remove(),s.isExist("#iweb-dialog")||$("body").removeClass("iweb-disable-scroll"),"function"==typeof e&&e(!0)}),$(document).on("click",".iweb-alert .async-content > div > .btn-no",function(){$(document).off("click",".iweb-alert .async-content > div > .btn-yes"),$(document).off("click",".iweb-alert .async-content > div > .btn-no"),$("#iweb-alert").remove(),s.isExist("#iweb-dialog")||$("body").removeClass("iweb-disable-scroll"),"function"==typeof e&&e(!1)})})}},dialog:function(i,e,t,s){if(!this.isExist("#iweb-dialog")){this.processing(!1,0);var a="";this.isValue(s)&&this.isValue(s.class)?a+='<div id="iweb-dialog" class="iweb-dialog iweb-dialog-'+s.class+'">':a+='<div id="iweb-dialog" class="iweb-dialog">',a+="<div>",a+='<div class="async-loading">',a+='<svg class="icon" x="0px" y="0px" viewBox="0 0 150 150">',a+='<circle class="circle" cx="75" cy="75" r="60"></circle>',a+="</svg>",a+="</div>",a+='<div class="async-virtual"></div>',a+='<div class="async-content">',a+='<a class="btn btn-close">×</a>',a+="<div>",a+=i,a+="</div>",a+="</div>",a+="</div>",a+="</div>",$(".iweb > .iweb-viewer").prepend(a).each(function(){$("body").hasClass("iweb-macosx")?$("#iweb-dialog > .inner").iScroll({mode:"macosx"}):$("body").addClass("iweb-disable-scroll"),"function"==typeof e&&e(),$(document).on("click",".iweb-dialog .async-virtual",function(i){$(document).off("click",".iweb-dialog .async-virtual"),$(document).off("click",".iweb-dialog .async-content .btn-close"),$("#iweb-dialog").remove(),$("body").removeClass("iweb-disable-scroll"),"function"==typeof t&&t()}),$(document).on("click",".iweb-dialog .async-content .btn-close",function(){$(document).off("click",".iweb-dialog .async-virtual"),$(document).off("click",".iweb-dialog .async-content .btn-close"),$("#iweb-dialog").remove(),$("body").removeClass("iweb-disable-scroll"),"function"==typeof t&&t()});var i=setTimeout(function(){$(".iweb-dialog .async-loading").remove(),$(".iweb-dialog .async-content").animate({opacity:1}),clearTimeout(i)},1e3)})}},post:function(i,e){var t=this,s=!1,a="",n={},o="json";t.isValue(i)&&(t.isValue(i.url)&&(a=i.url,s=!0),t.isValue(i.val)&&(n=i.val),t.isValue(i.type)&&(o=i.type)),s&&!t.processing_status&&(t.processing_status=!0,t.isValue(i.loading)&&t.processing(!0,!0),$.ajax({url:a,type:"post",data:n,dataType:o,success:function(i){"function"==typeof e&&e(i);var s=setTimeout(function(){t.processing_status=!1,t.processing(!1,0),clearTimeout(s)},1e3)},error:function(i,e,s){return t.processing_status=!1,t.processing(!1,0),alert(s),!1}}))},form:function(i,e,t,s){var a=this;if(i="#"+i.toString().replace("#",""),a.isExist(i)){object=this;var n="json";a.isValue(e)&&(n=e),a.isValue($(i).data("token"))&&(a.csrf_token=$(i).data("token"),$(i).removeAttr("data-token")),$(i).ajaxForm({dataType:n,beforeSubmit:function(i,e,s){if(a.processing_status)return!1;if("function"==typeof t&&!t(i))return!1;if(a.csrf_token.length>0){var n=a.randomNum(1,Math.ceil(a.csrf_token.length/3)),o=a.randomString();i.push({name:"async_index",value:n}),i.push({name:"csrf_token",value:a.csrf_token.substr(n,o.length)+o}),a.setCookie("client_token",o)}return a.processing_status=!0,a.processing(!0,!0),"function"!=typeof t||void 0},success:function(i){a.isValue(a.getCookie("client_token"))&&a.setCookie("client_token","",-1),"function"==typeof s&&s(i);var e=setTimeout(function(){a.processing_status=!1,a.processing(!1,0),clearTimeout(e)},1e3)},error:function(i,e,t){return a.isValue(a.getCookie("client_token"))&&a.setCookie("client_token","",-1),a.processing_status=!1,a.processing(!1,0),alert(t),!1}})}},isValue:function(i){return null!=i&&("object"==typeof i||"array"==typeof i?parseInt(Object.keys(i).length)>0:"boolean"==typeof i?i:""!==$.trim(i))},isNumber:function(i){if(this.isValue(i)){return/^[0-9]+$/.test(i)}return!1},isEmail:function(i){if(this.isValue(i)){return/^([A-Za-z0-9_\-\.])+\@([A-Za-z0-9_\-\.])+\.([A-Za-z]{2,})$/.test(i)}return!1},isPassword:function(i){if(this.isValue(i)){return/^(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{6,}$/.test(i)}return!1},isMatch:function(i,e,t){return!(!this.isValue(i)||!this.isValue(e))&&(iweb.isValue(t)&&(t||1===parseInt(t))?$.trim(i).toString()===$.trim(e).toString():$.trim(i).toString().toLowerCase()===$.trim(e).toString().toLowerCase())},isExist:function(i){return parseInt($(i).length)>0},detectDevice:function(i){var e=function(){return navigator.userAgent.match(/Android/i)},t=function(){return navigator.userAgent.match(/BlackBerry/i)},s=function(){return navigator.userAgent.match(/Mac|iPhone|iPad|iPod/i)},a=function(){return navigator.userAgent.match(/Opera Mini/i)},n=function(){return navigator.userAgent.match(/IEMobile/i)};switch(i){case"android":return e();case"blackberry":return t();case"ios":return s();case"opera":return a();case"windows":return n();default:return e()||t()||s()||a()||n()}},setCookie:function(i,e,t){if(navigator.cookieEnabled){if(this.isValue(i)){this.isValue(t)||(t=7);var s=new Date;s.setTime(s.getTime()+24*t*60*60*1e3);var a="expires="+s.toUTCString();document.cookie=i+"="+e+";"+a+";path=/"}}else alert("Cookies Blocked or not supported by your browser.")},getCookie:function(i){if(navigator.cookieEnabled)for(var e=i+"=",t=document.cookie.split(";"),s=0;s<t.length;s++){for(var a=t[s];" "==a.charAt(0);)a=a.substring(1);if(0==a.indexOf(e))return a.substring(e.length,a.length)}else alert("Cookies Blocked or not supported by your browser.");return""},getUrlParameter:function(i){var e="";if(this.isValue(i))for(var t=window.location.search.substring(1).split("&"),s=0;s<parseInt(t.length);s++){var a=t[s].split("="),n=a[0],o=a[1];if(this.isValue(n)&&this.isValue(o)&&this.isMatch(n,i)){e=o;break}}return e},randomNum:function(i,e){return(!this.isValue(i)||parseInt(i)<0)&&(i=0),(!this.isValue(e)||parseInt(e)<1)&&(e=1),i=parseInt(i),e=parseInt(e),parseInt(i)>parseInt(e)&&(i=0,e=1),parseInt(Math.random()*(e+1-i)+i)},randomString:function(i){var e="0123456789ABCDEFGHIJKLMNOPQRSTUVWXTZabcdefghiklmnopqrstuvwxyz";this.isNumber(i)||(i=12);for(var t="",s=0;s<i;s++){var a=Math.floor(Math.random()*e.length);t+=e.substring(a,a+1)}return t}};
